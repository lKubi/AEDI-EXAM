    ...
    private Jugador jugarTurnos(Jugador jugadorInicial){
        ...
        while(!terminoPartida){
            ...
            if(!jugadorActual.getCartasCandidatas(mesaJuego).isEmpty()){
                ...
                contador = 0;
            }else if(jugadorActual.getCartasCandidatas(mesaJuego).isEmpty() &&
                    jugadorActual.getNumCartasMano() != 0){
                contador++;
            }else{
            ...
            if(jugadorActual.getNumCartasMano() == 0){
                ...
                terminoPartida = true;
                toret = jugadorActual;
            }else if(contador == jugadores.size()){
                System.out.println("\nLos jugadores no pueden poner más cartas.\n\nTABLAS");
                terminoPartida = true;
            }
